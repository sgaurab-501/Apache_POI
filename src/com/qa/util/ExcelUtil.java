...
public String getCellData(String sheetName, int rowNum, int colNum) throws Exception {
	...
	String data;
	try {
	data = formatter.formatCellValue(cell);// Returns the formatted value of cell as String regardless of the type of data in cell
	}
	catch(Exception e) {
	data=" ";
	}
...
public void setCellData(String sheetName, int rowNum, int colNum, String data) throws IOException {
	...
	if(sheet.getRow(rowNum)==null) // If row does not exist then create a new one
	{
